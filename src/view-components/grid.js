...
function createGridTemplate (grid, canvas, context, legend) {
  ...
  for (let i = 0; i < cols + 1; i++) {
    ...
    ctx.fillText("label", xColCoord + xLabelTextWidth + Y_AXIS_TEXT_PADDING,
      ROW_HEIGHT * rows + paddingTop + X_AXIS_TEXT_PADDING);
